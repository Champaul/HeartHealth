...
<body>
<form action="user/selLg" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="javascript:void(0)">日志管理</a></li>
		<li><a href="javascript:void(0)">日志信息</a></li>
	</ul>
</div>
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
			<label>登录人</label>
			<input name="dlr"  type="text" class="dfinput" placeholder="请输入登录人" />
		</li>
		<li>
			<label>&nbsp;</label>
		...
		<c:if test="${!empty list}">
			...
			<tr>
				...
				<td>${list.dlsj}</td>
				<td>
					<a href = "user/deleteLg?id=${list.id}"><font color="blue">删除</font></a>
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="pagin">
			<ul class="paginList">
				...
				<a href="user/selLg?page=1">首页</a>&nbsp;&nbsp;
			    <a href="user/selLg?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a>&nbsp;&nbsp;
			    <a href="user/selLg?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a>&nbsp;&nbsp;
			    <a href="user/selLg?page=${pageInfo.pages}">尾页</a>&nbsp;&nbsp;
			</ul>
	    </div>
</form>
