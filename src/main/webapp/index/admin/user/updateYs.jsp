...
<div class="place">
	...
	<ul class="placeul">
		...
		<li><a href="javascript:void(0)">修改医生信息</a></li>
	</ul>
</div>

<form action = "user/updateXx" method = "post"  class="validate" onsubmit="return add();" >
	<div class="formbody">
	...
	<input type="hidden" name="role" value="1"/>
		...
		<ul class="forminfo">
			...
			<li>
			 ...
			 <li>
				<label>科室</label>
				<input name="jsnumber"  value="${user.jsnumber}" type="text" class="dfinput  " placeholder="请输入科室" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>类型</label>
				<select class="dfinput" name="chexing"  > 
					<option value="${user.chexing}">${user.chexing}</option>
			...
			<li>
				<label>简介</label>
				<textarea name="state" id="content" id="editor_id" cols="100" rows="8" style="width:400px;height:100px" class="dfinput" placeholder="请输入简介" >${user.state}</textarea><font color="red">*</font>
			</li>
			<li>
				<label>&nbsp;</label>
