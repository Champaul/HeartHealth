...
<body>
<form action="comm/selBf" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="javascript:void(0)">测试记录管理</a></li>
		<li><a href="javascript:void(0)">查看测试记录信息</a></li>
	</ul>
</div>
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
				<label>用户姓名</label>
				<input name="account" id="sale" type="text" class="dfinput " placeholder="请输入用户姓名" />
			</li>
		<li>
			<label>&nbsp;</label>
		...
		<c:if test="${!empty list}">
			...
			<tr>
				...
				<td>${list.bfrq}</td>
				<td>
					<a href = "comm/deleteBf?id=${list.id}"><font color="blue">删除</font></a>
				</td>
			<%-- 	<td>
					<a href = "<%=basePath %>comm/selLx?fs=${list.fk}"><font color="blue">点击查看</font></a>
				</td>	 --%>
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="pagin">
			<ul class="paginList">
				...
				<a href="comm/selBf?page=1">首页</a>&nbsp;&nbsp;
			    <a href="comm/selBf?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a>&nbsp;&nbsp;
			    <a href="comm/selBf?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a>&nbsp;&nbsp;
			    <a href="comm/selBf?page=${pageInfo.pages}">尾页</a>&nbsp;&nbsp;
			</ul>
	    </div>
</form>
