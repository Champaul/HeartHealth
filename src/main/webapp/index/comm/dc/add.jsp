...
<form action = "comm/addDc" method = "post" enctype="multipart/form-data"  class="validate" onsubmit="return add();" >
	<div class="formbody">
		<div class="formtitle"><span>基本信息</span></div>
		<ul class="forminfo">
			<li>
				<label>标题</label>
				<input name="mycd" id="sale" type="text" class="dfinput required" placeholder="请输入标题" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			<li>
				<label>图片</label>
				<input name="file" id="photo" type="file" onchange="preview(this,'preview','imghead',150,100)"/>
				<div id="preview">
