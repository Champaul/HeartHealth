...
<form action = "comm/updateDc" method = "post"  class="validate" onsubmit="return add();" >
<input name="id" id="account" type="hidden"  value="${data.id}" />
	<div class="formbody">
		...
		<ul class="forminfo">
			...
			<li>
				<label>标题</label>
				<input name="mycd" value="${data.mycd}" type="text" class="dfinput required" placeholder="请输入标题" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			 <li>
				<label>内容</label>
