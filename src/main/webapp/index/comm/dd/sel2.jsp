...
<script type="text/javascript">
	  	function selSp(id){
	          var d = dialog({
	                ...
	                width:500,
	                height:350,
	                url:'comm/selSp?id='+id+'&type=yysp',//可以是一个访问路径Action|Servlet等或者jsp页面资源
	                onclose: function () {
...
<div class="place">
	...
	<ul class="placeul">
		...
		<li><a href="javascript:void(0)">预约信息</a></li>
	</ul>
</div>
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
			<label>患者姓名</label>
			<input name="account"  type="text" class="dfinput" placeholder="请输入患者姓名" />
		</li>
		<li>
			<label>&nbsp;</label>
		...
		<c:if test="${!empty list}">
			...
			<tr>
				...
				<td>${list.state}</td>
				<td>
					<a href = "comm/deleteDd?id=${list.id}"><font color="blue">取消预约</font></a>
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar1">
				<li class="click"><span><img src="<%=basePath %>resource/admin/images/t01.png"/></span><a href="comm/tz?type=ssjl">添加预约</a></li>
				</ul>
			</div>
		</div>
	<div class="pagin">
			<ul class="paginList">
				...
				<a href="comm/selDd?page=1">首页</a>&nbsp;&nbsp;
			    <a href="comm/selDd?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a>&nbsp;&nbsp;
			    <a href="comm/selDd?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a>&nbsp;&nbsp;
			    <a href="comm/selDd?page=${pageInfo.pages}">尾页</a>&nbsp;&nbsp;
			</ul>
	    </div>
</form>
