...
<div class="place">
	...
	<ul class="placeul">
		...
		<li><a href="javascript:void(0)">添加建议</a></li>
	</ul>
</div>
...
<form action = "comm/addLx" method = "post"  class="validate" onsubmit="return add();" >
	<div class="formbody">
		...
		<ul class="forminfo">
			<li>
				<label>标题</label>
				<input name="name" id="sale" type="text" class="dfinput required" placeholder="请输入标题" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			<li>
				<label>建议分数</label>
				<input name="tel" id="sale" type="text" class="dfinput required" placeholder="请输入建议分数" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			 <li>
				<label>内容</label>
