...
<body>
<form action="comm/selLx" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="javascript:void(0)">建议管理</a></li>
		<li><a href="javascript:void(0)">查看建议</a></li>
	</ul>
</div>
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
			<label>标题</label>
			<input name="name"  type="text" class="dfinput" placeholder="请输入标题" />
		</li>
		<li>
			<label>&nbsp;</label>
		...
		<c:if test="${!empty list}">
			...
			<tr>
				...
				<td>${list.content}</td>
				<td>
					<a href = "comm/showLx?id=${list.id}"><font color="blue">编辑</font></a>&nbsp;&nbsp;&nbsp;
					<a href = "comm/deleteLx?id=${list.id}"><font color="blue">删除</font></a>
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar1">
				<li class="click"><span><img src="<%=basePath %>resource/admin/images/t01.png"/></span><a href="index/comm/lxr/add.jsp">添加建议</a></li>
				</ul>
			</div>
		</div>
		<div class="pagin">
			<ul class="paginList">
				...
				<a href="comm/selLx?page=1">首页</a>&nbsp;&nbsp;
			    <a href="comm/selLx?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a>&nbsp;&nbsp;
			    <a href="comm/selLx?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a>&nbsp;&nbsp;
			    <a href="comm/selLx?page=${pageInfo.pages}">尾页</a>&nbsp;&nbsp;
			</ul>
	    </div>
</form>
