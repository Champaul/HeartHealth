...
<div class="place">
	...
	<ul class="placeul">
		...
		<li><a href="javascript:void(0)">编辑建议</a></li>
	</ul>
</div>

<form action = "comm/updateLx" method = "post"  class="validate" onsubmit="return add();" >
<input name="id" id="account" type="hidden"  value="${data.id}" />
	<div class="formbody">
		...
		<ul class="forminfo">
			<li>
				<label>标题</label>
				<input name="name"  value="${data.name}" type="text" class="dfinput required" placeholder="请输入标题" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			<li>
				<label>建议分数</label>
				<input name="tel"  value="${data.tel}" type="text" class="dfinput required" placeholder="请输入建议分数" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			 <li>
				<label>内容</label>
