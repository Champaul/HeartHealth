...
<div class="place">
	...
	<ul class="placeul">
		...
		<li><a href="javascript:void(0)">添加出诊</a></li>
	</ul>
</div>

<form action = "comm/addRc" method = "post"  class="validate" onsubmit="return add();" >
	<div class="formbody">
		...
		<ul class="forminfo">
			...
			<li>
				<label>主题</label>
				<input name="title" id="sale" type="text" class="dfinput required" placeholder="请输入主题" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			<li>
				<label>出诊日期</label>
				<input name="zxrq" id="sale" type="text" class="dfinput required date" placeholder="请输入出诊日期" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			 <li>
				<label>备注</label>
