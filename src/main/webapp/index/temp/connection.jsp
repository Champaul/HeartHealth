...
<div class="container"> 		
        ...
        <li>
          <h3><a href="<%=basePath %>index/temp/about.jsp">团队介绍</a></h3>
        ...
        <li>
          <h3><a href="connection.jsp">联系我们</a></h3>
        	...
        	<div class="rightbar">
            	...
            	<div class="bread"><a href="<%=basePath %>temp/index.html">首页</a> >联系我们</div>

                <div class="contact_nei">
 <div class="luxian_l">
	<p>
		地址：江苏省南京市江宁区弘景大道99号<br />
电话：18761217896<br />
 </div>
