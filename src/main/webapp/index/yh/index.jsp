...
<%--  </ul>--%>
  ...
  <ul>
    <li><a href="comm/tzcs" target="right"><span class="icon-caret-right"></span>健康测试</a></li> 
    <li><a href="comm/selBf" target="right"><span class="icon-caret-right"></span>测试记录</a></li>
    <li><a href="comm/selFx" target="right"><span class="icon-caret-right"></span>测试分析</a></li>
    <li><a href="comm/history" target="right"><span class="icon-caret-right"></span>历史记录</a></li>
  </ul>  
