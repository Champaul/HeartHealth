...
<form action = "user/updateMyXx" method = "post"  class="validate" onsubmit="return add();" >
	<div class="formbody">
	<input type="hidden" name="id" value="${user.id}"/>
		...
		<ul class="forminfo">
			...
			<li>
				<label>职业</label>
				<input name="address" id="name" type="text" value="${user.address}" class="dfinput  " placeholder="请输入职业" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			 <li>
				<label>身份证号码</label>
			...
			<li>
				...
				<select class="dfinput" name="chexing"  > 
					<option value="${user.idk}">${user.idk}</option>
					<option value="">请选择角色</option>
					<option value="轻度抑郁">轻度抑郁</option>
					<option value="中度抑郁">中度抑郁</option>
					<option value="重度抑郁">重度抑郁</option>
				</select>
			</li>
			<li>
				<label>&nbsp;</label>
