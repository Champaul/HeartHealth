...
<div class="place">
	...
	<ul class="placeul">
		...
		<li><a href="javascript:void(0)">添加医生</a></li>
	</ul>
</div>

<form action = "user/saveUserYs" method = "post" enctype="multipart/form-data" class="validate" onsubmit="return add();" >
	<div class="formbody">
		...
		<ul class="forminfo">
			...
			<li>
			 ...
			 <li>
				<label>科室</label>
				<input name="jsnumber"  type="text" class="dfinput  " placeholder="请输入科室" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>类型</label>
			...
			<li>
				<label>简介</label>
				<textarea name="state" id="content" id="editor_id" cols="100" rows="8" style="width:400px;height:100px" class="dfinput" placeholder="请输入简介" ></textarea><font color="red">*</font>
			</li>
			<li>
				<label>&nbsp;</label>
